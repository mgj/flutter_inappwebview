...
Forked to support building inappwebview 5.8.0 on MacOS 15.
* iOS: fix evaluateJavaScript() in InAppWebView.swift
* Android: remove v1 embedding, fix v2 plugin registrar embedding
